...
public class TimekeeperTabFragment extends SherlockFragment implements OnSharedPreferenceChangeListener {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		_timekeeperDisplay[1] = (ImageView) getView()
		        .findViewById(R.id.tenMinuteImg);
		_timekeeperDisplay[2] = (ImageView) getView()
		        .findViewById(R.id.minuteImg);
		_timekeeperDisplay[3] = (ImageView) getView()
		        .findViewById(R.id.tenSecondImg);
		_timekeeperDisplay[4] = (ImageView) getView()
		        .findViewById(R.id.secondImg);
		_timekeeperDisplay[5] = (ImageView) getView()
		        .findViewById(R.id.hundredthImg);
		...
		_extraButton.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Log.d(TAG, "_resetLapButton clicked");
				if (_timekeeper.isRunning()) {
